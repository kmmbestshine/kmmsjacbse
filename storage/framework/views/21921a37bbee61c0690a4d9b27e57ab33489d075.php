...
<head>        
        ...
        <link rel="icon" href="<?php echo e(url('users/img/st-joseph.png')); ?>" type="image/x-icon" />
        <link href="<?php echo e(url('~admin/css/styles.css')); ?>" rel="stylesheet" type="text/css" />
        ...
        <script type="text/javascript" src="<?php echo e(url('~admin/js/plugins/jquery-validation/jquery.validate.min.js')); ?>"></script>
            ...
            <div class="page-content page-content-default">
                ...
                <div class="block-login" style="margin-top: 25px;">
                    ...
                    <div class="block-login-content" style="margin-top: 75px;">
                        <h1>Sign in</h1>
                        <form id="signinForm" method="post" action="<?php echo e(route('loginRequest')); ?>">
                        <?php echo csrf_field(); ?>    
