<?php $__env->startSection('title', 'New Recruitment'); ?>
...
<?php $__env->startSection('contant'); ?>
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="alert alert-danger" role="alert">
                    ...
                    <strong>Oh Snap!</strong> <?php echo e($msg1); ?>
	...
	<div class="row">
        <div class="col-md-12">
            ...
            <form class="form-horizontal" role="form" method="post" action="<?php echo e(route('post.biodata')); ?>" enctype="multipart/form-data">
            	<?php echo csrf_field(); ?>
								...
								<div class="col-md-6">
									<div class="form-group">
			                            ...
			                            <div class="col-md-9 col-xs-12">                         
			                                <input type="text" class="form-control" name="name" value="<?php echo e(Input::old('name')); ?>" required>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-9">
											...
											<input type="hidden" class="form-control" name="username" value="<?php echo e($username); ?>">
											<input type="hidden" class="form-control" name="password" value="<?php echo e($password); ?>">
										</div>
									</div>
								</div>
							</div>
