...
<?php $__env->startSection('contant'); ?>
    ...
    <div class="page-content-wrap">
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal" role="form" method="post" action="<?php echo e(route('post.notification')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>

                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Add Notification</strong></h3>
                        </div>
                        <div class="panel-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 worksubject">
                                            ...
                                            <?php foreach($errors->get('title') as $title): ?>
                                                <div class="alert alert-danger my-alert" role="alert">
                                                    <button type="button" class="close" data-dismiss="alert">
                                                        <span aria-hidden="true">&times;</span>
                                                        <span class="sr-only">Close</span>
                                                    </button> <?php echo e($title); ?>
                            ...
                            <div class="row">
                                <div class="col-md-12 text-right">
                                    <button type="submit" class="btn btn-info btn-lg">Add Notification</button>
                                </div>
                            </div>
                        </div>  
                    </div>
                            ...
                            <tbody>
                                <?php foreach($notifications as $key => $notification): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('edit.notification', $notification->id)); ?>" class="btn btn-info">Edit</a>
                                        </td>
                                        <td>
                                            <a href="<?php echo e(route('delete.notification', $notification->id)); ?>" class="btn btn-danger" onclick="confirm('Are You Sure')">Delete</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
