...
<?php $__env->startSection('contant'); ?>
    ...
    <div class="page-content-wrap">
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal" role="form" method="post" action="<?php echo e(route('get.library.subject_report')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                         <select name="subject_id" class="form-control">
                                                ...
                                                <?php foreach($subjects as $key => $get): ?>
                                                <option value="<?php echo e($get->id); ?>"><?php echo e($get->book_subject); ?></option>
