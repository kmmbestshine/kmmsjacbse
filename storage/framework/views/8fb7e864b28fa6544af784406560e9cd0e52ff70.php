<?php $__env->startSection('title', 'View Syllabus'); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12 table-responsive">
                                        <table class="table table-striped table-datatable">
                                            ...
                                            <tbody>
                                            <?php if(isset($allSyllabus)): ?>
                                                <?php foreach($allSyllabus as $key => $syll): ?>
                                                <tr>
                                                    <td><?php echo e($key+1); ?></td>
                                                    <td> <?php echo e(ucfirst($syll->class)); ?></td>
                                                    <td><?php echo e(ucfirst($syll->subject)); ?></td>
                                                    <td>
                                                        <a href="<?php echo e(route('editSyllabusId', $syll->id)); ?>" class="btn btn-primary" title="Edit Syllabus">
                                                            <i class="fa fa-pencil" aria-hidden="true"></i>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="<?php echo e(route('deleteSyllabusId', $syll->id)); ?>" class="btn btn-danger" title="Delete Syllabus">
