<?php $__env->startSection('title', 'Data Manager'); ?>
...
<?php $__env->startSection('contant'); ?>
    ...
    <div class="page-content-wrap">
        <div class="row">
            <div class="col-md-12">
            	<form class="form-horizontal" role="form" method="post" action="<?php echo e(route('post.manager')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                        			...
                        			<div class="col-md-12">
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <a href="<?php echo e(url('data-manager/student.xlsx')); ?>" class="btn btn-info">Student Sample File</a>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <?php /* <a href="<?php echo e(url('data-manager/emp.xlsx')); ?>" class="btn btn-info">Employee Sample File</a>
                                                        */ ?>
                                                        <a href="<?php echo e(url('data-manager/sample_employee.xlsx')); ?>" class="btn btn-info">Employee Sample File</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
