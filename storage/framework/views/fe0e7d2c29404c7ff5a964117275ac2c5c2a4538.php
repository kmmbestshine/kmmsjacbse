...
<div class="background">
    <div class="login-container">
        ...
        <div class="login-box animated fadeInDown">
            ...
            <?php if(Input::old('message')): ?>
                <div class="login-title" style="color:red;"><strong>Ooho!</strong>, <?php echo e(Input::old('message')); ?></div>
            <?php else: ?>
            ...
            <?php endif; ?>
                ...
                <form action="<?php echo e(route('loginRequest')); ?>" class="form-horizontal" method="post">
                <?php echo csrf_field(); ?>
            ...
            <div class="login-footer">
                ...
                <a class="btn btn-danger btn-rounded" href="<?php echo e(route('joboppournityschool')); ?>">Job Oppourtunity</a>
                </div>
